...
let songs = [
    ...
    },
    {
      ...
      lyrics: [
        ...
        { time: 9.9, text: "You think you broke my heart, oh, girl, for goodness' sake" },
        { time: 14.8, text: "You think I'm crying on my own, well, I ain't" },
        { time: 19.7, text: "And I didn't wanna write a song" },
        { time: 22.2, text: "'Cause I didn't want anyone thinkin' I still care, I don't, but" },
        { time: 26.6, text: "You still hit my phone up" },
        { time: 29.4, text: "And baby, I'll be movin' on" },
        { time: 31.5, text: "And I think you should be somethin' I don't wanna hold back" },
        ...
        { time: 51.30, text: "Didn't see what's going on, but now I know" },
        { time: 55.60, text:"I'm better sleeping on my own" },
        { time: 58.30, text:"'Cause if you like the way you look that much" },
        { time: 63, text:"Oh, baby, you should go and love yourself" },
        { time: 67.6, text:"And if you think that I'm still holdin' on to somethin'" },
        ...
        { time: 99.1, text:"'Cause I didn't want anyone thinkin' I still care, I don't, but" },
        { time: 104.4, text:"You still hit my phone up" },
        { time: 106.1, text:"And baby, I'll be movin' on" },
        { time: 108.5, text:"And I think you should be somethin' I don't wanna hold back" },
        ...
        { time: 144.5, text:"And if you think that I'm still holdin' on to somethin'" },
        ...
        { time: 201.7, text:"And if you think that I'm still holdin' on to somethin'" },
    ...
    },
    {
      ...
      lyrics: [
        ...
        { time: 104.2, text:"You and I (don't let go) were alive (don't let go)" },
        { time: 114.5, text:"With nothing to do, I could lay and just look in your eyes" },
        ...
        { time: 184.4, text:"There was something 'bout you that now I can't remember" },
        { time: 189.6, text:"It's the same damn thing that made my heart surrender" },
    ...
    },
    {
      ...
      lyrics: [
        { time: 54.4, text: "It's making you cry every time you give your love to me this way" },
        { time: 68, text: "Saying you'd wait for me to stay, I know it hurts you," },
        ...
        { time: 109, text: "Maybe I'd change for you someday, but I can't help the way I feel" },
        { time: 121.3, text: "Wish I was good, wish that I could give you my love now..." },
